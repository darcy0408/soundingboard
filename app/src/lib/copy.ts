// Compliance copy — verbatim per SPEC.md §5. Do not edit wording; changes go through the
// planning model (same rule as the prompts in /prompts).

export const AI_CONSENT_TEXT =
  "Your conversation is processed by a third-party AI service to generate responses. Conversations aren't stored on our servers.";
